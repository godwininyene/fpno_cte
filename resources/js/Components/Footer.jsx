  ...
  return (
    <footer className="bg-slate-950 py-10">
        <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row justify-center items-center border-b border-b-slate-400 pb-3">
                ...
                <div className="w-1/3 grow my-5 lg:my-0">
                    <ul className="flex items-center text-center justify-center">
                        ...
                        <li className="mr-5 inline-block">
                            <a href="about" className="transition-all duration-100 text-white hover:text-primary">Objectives</a>
                        </li>
                    
                        <li className="mr-5 inline-block">
                            <a href="contact-us" className="transition-all duration-100 text-white hover:text-primary">Programmes</a>
                        </li>
                        <li className="mr-5 inline-block">
                            <a href="report" className="transition-all duration-100 text-white hover:text-primary">Staff</a>
                        </li>
                        <li className="mr-5 inline-block">
                            <a href="report" className="transition-all duration-100 text-white hover:text-primary">Students Excos</a>
                        </li>
                    </ul>
                </div>
            ...
            <p className="text-center text-slate-300 text-sm lg:text-base mt-5">&copy; 2023 Department of Computer Engineering FPNO. All Rights Reserved.</p>
        </div>
</footer>
  )
}
